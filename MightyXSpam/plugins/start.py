...
MIG_IMG = ALIVE_PIC if ALIVE_PIC else "https://te.legra.ph/file/65494c9266c3ea92c49dc.jpg"
...
Mig_Button = [
        ...
        [
        Button.inline("⚡ 𝖈𝖔𝖒𝖒𝖆𝖓𝖉𝖘 ⚡", data="help_back")
        ]
        ]
...
MigX_Button = [
        ...
        [
        Button.url("🔥 𝖗𝖊𝖕𝖔 🔥", "https://github.com/AAAPOPNUCKEAR/MightyBotSpamDeploy")
        ]
        ]
